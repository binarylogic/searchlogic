...
*	<tt>Documentation:</tt> http://searchgasm.rubyforge.org
*	<tt>Easy pagination, ordering, and searching tutorial:</tt> http://www.binarylogic.com/2008/9/7/tutorial-pagination-ordering-and-searching-with-searchgasm
*	<tt>The tutorial above, live:</tt> http://searchgasm_example.binarylogic.com
