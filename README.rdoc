...
*	<b>Documentation:</b> {http://searchgasm.rubyforge.org}[http://searchgasm.rubyforge.org]
*	<b>Live rails example:</b> {http://searchgasm_example.binarylogic.com}[http://searchgasm_example.binarylogic.com]
...
<b>See this example live: {http://searchgasm_example.binarylogic.com}[http://searchgasm_example.binarylogic.com]</b>
