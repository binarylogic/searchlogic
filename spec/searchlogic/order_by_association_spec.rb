...
describe Searchlogic::Conditions::Joins do 
  before(:each) do 
    ...
    order3 = Order.create(:total=>16, :line_items => [LineItem.create(:price => 8), LineItem.create(:price => 7)])
    order4 = Order.create(:total=>15, :line_items => [LineItem.create(:price => 6), LineItem.create(:price => 5)])
