...
if defined?(ActionView)
  ActionView::Base.send(:include, BinaryLogic::Searchgasm::Helpers::FormHelper::Base)
  ...
  ActionView::Helpers::FormBuilder.send(:include, BinaryLogic::Searchgasm::Helpers::FormHelper::FormBuilder)
